 ...
 * @author Genet
 */
public class TransformSpectrum {// implements ITransform{
    
    
//    
//     private EnTransform transformation; // Trasnformation type (4 options: LOG10, LOG2, RECIPROCAL, SQR_ROOT)
...
//     */
//    public TransformSpectrum(EnTransform transformation, MSnSpectrum spectrum) {
...
//        if (transformation.equals(EnTransform.LOG_2)) {
//            log_base = 2;
//        }
//    }
//
...
//    public EnTransform getTransformation() {
//        return transformation;
//    }
//
//    public void setTransformation(EnTransform transformation) {
...
//            return false;
//        }
//        final TransformSpectrum other = (TransformSpectrum) obj;
